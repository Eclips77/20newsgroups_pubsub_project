...
class SubscriberConfig:
	def __init__(self) -> None:
		...
		self.KAFKA_TOPIC: str = os.getenv("KAFKA_TOPIC_INTERESTING", "interesting")
		self.GROUP_ID: str = os.getenv("GROUP_ID", "interesting-subscriber-group")
		self.MONGO_URI: str = os.getenv("MONGO_URI", "mongodb://localhost:27017")
		self.MONGO_DB: str = os.getenv("MONGO_DB", "newsdb")
		self.COLLECTION_NAME: str = os.getenv("MONGO_COLL", "interesting_messages")
